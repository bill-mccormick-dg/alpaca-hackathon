...
def build_block(scales: dict[int, float]) -> str:
    ...
    # 100% and overflowed: titles clipped off the top, code blocks crushed.
    # The measured box is the 1280x720 page, so on a taller viewport these
    # scales are merely conservative, and what you see on screen is now what
    # exports.
    return (
