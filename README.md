...
| `mail_report.py [--dry-run]` | Hourly team email: summary plus trades / cycles / equity as CSV attachments. Read-only, its own cron entry, sends nothing when no recipients are configured |
