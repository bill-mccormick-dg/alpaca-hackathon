...
class Warnings(unittest.TestCase):
    ...
    def test_a_broken_replicate_pair_is_caught(self):
        ...
        w = fingerprint_run.warnings(_fp(b={"take_profit_pct": 55}))
    ...
    def test_mixed_differing_in_a_real_value_is_caught(self):
        w = fingerprint_run.warnings(_fp(variant={"take_profit_pct": 70}))
    ...
    def test_a_past_final_flatten_date_is_caught(self):
        ...
        w = fingerprint_run.warnings(_fp(a=past, b=past, variant=past))
    ...
    def test_a_future_final_flatten_date_is_fine(self):
        ...
        self.assertEqual(fingerprint_run.warnings(_fp(a=future, b=future, variant=future)), [])
    ...
    def test_an_empty_final_flatten_date_is_fine(self):
        ...
        self.assertEqual(fingerprint_run.warnings(_fp(a=blank, b=blank, variant=blank)), [])
